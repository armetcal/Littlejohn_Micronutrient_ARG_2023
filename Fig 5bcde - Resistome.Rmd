...
data_5c = p$data %>% select(Diet,Resistance_Mechanism,Count,qval,symb)

ggsave('Plots/Functional/Fig. 5d - Resistance Mechanisms.png',height=6,width=8)
```

# Fig. 5d - Correlations with Pathobionts
...
```{r Save}
L = list('Fig 5b' = data_5b, 
         'Fig 5c' = data_5c,
         'Fig 5d' = data_5d,
         'Fig 5e' = data_5e)
writexl::write_xlsx(L,'Source Data/Source Data Fig 5.xlsx')
```
