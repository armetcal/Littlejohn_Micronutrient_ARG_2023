...
ggsave('Plots/Bacteriome/P1_alphadiversity.png',height = 3.5, width = 6)
```
...
ggsave('Plots/Bacteriome/P1_betadiversity.png',height = 5, width = 7)
```
...
write.csv(beta_stats,'Results Files/Bacteriome/S1_beta_diversity_statistics.csv',row.names = F)
...
pp = plot_ordered_bar(phylum3,fill = 'Phylum') +xlab('')

ggsave('Plots/Bacteriome/P1_barplots_phylum.png',height = 6, width = 7)
...
pf = plot_ordered_bar(family3,fill = 'Family') +xlab('')

ggsave('Plots/Bacteriome/P1_barplots_family.png',height = 6, width = 10)
...
pg = plot_ordered_bar(genus3,fill = 'Genus') +xlab('')

ggsave('Plots/Bacteriome/P1_barplots_genus.png',height = 6, width = 10)
...
ps = plot_ordered_bar(species3,fill = 'Species') +xlab('')

ggsave('Plots/Bacteriome/P1_barplots_species.png',height = 6, width = 13)
```
...
ggsave('Plots/Bacteriome/P1_barplots_phylum_indiv.png',height = 8, width = 10)
...
ggsave('Plots/Bacteriome/P1_barplots_family_indiv.png',height = 8, width = 10)
...
ggsave('Plots/Bacteriome/P1_barplots_genus_indiv.png',height = 8, width = 10)
...
ggsave('Plots/Bacteriome/P1_barplots_species_indiv.png',height = 8, width = 10)
```

#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

# Barplots and Enterobacteriaceae CFUs figure
...
ggsave('Plots/Bacteriome/P1_enteroCFU.jpeg', height = 5, width =6)

# Create combined plot
# ga1 = ggarrange(plotlist = list(pp+theme_classic(base_size=14),
#                           pg+theme_classic(base_size=14)),ncol=2,nrow=1)
# ga2 = ggarrange(plotlist = list(ps+theme_classic(base_size=14)+
#                             theme(legend.text = element_text(size=10), 
#                                   legend.title = element_text(size=12)),
#                           en),ncol=2,nrow=1,widths = c(1.5,1))
# ggarrange(plotlist = list(ga1,ga2),ncol=1,nrow=2)
# ggsave('Plots/Bacteriome/P1_combined.jpeg',height=9,width=12)
```
...
writexl::write_xlsx(list('All Results' = res, 
                    ...
                    'Results Files/Bacteriome/Maaslin2_longitudinal_bacteria.xlsx')
saveRDS(list(Function=maas.sp,SL3=maas.g,SL2=maas.f,SL1=maas.p),
        'Results Files/Bacteriome/Maaslin2_longitudinal_bacteria.rds')
```
...
ggarrange(plotlist = lapply(list(gs,gg,gf,gp),function(x) x+ylim(0,13)+xlim(-15,15)), ncol = 2, nrow = 2,legend='none')

ggsave('Results Files/Bacteriome/Maaslin2_Volcano.jpeg',height = 6, width = 7.5)
```
