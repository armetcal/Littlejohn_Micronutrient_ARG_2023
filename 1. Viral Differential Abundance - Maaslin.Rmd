...
ggsave('Plots/Virome/P1_alphadiversity_Virome.png',height = 3.5, width = 6)
```
...
ggsave('Plots/Virome/P1_betadiversity_Virome.png',height = 5, width = 7)
```
...
write.csv(beta_stats,'Results Files/Virome/S1_beta_diversity_statistics.csv',row.names = F)
...
temp3 = tax_table(phylum2) %>% as.data.frame() %>% # Adjust the taxonomy table
  rbind('Unknown/Other' = c('Viruses',rep('Unknown/Other',6))) %>% as.matrix()
...
ggsave('Plots/Virome/P1_barplots_phylum_Virome.png',height = 6, width = 10)
...
ggsave('Plots/Virome/P1_barplots_family_Virome.png',height = 6, width = 10)
...
ggsave('Plots/Virome/P1_barplots_genus_Virome.png',height = 6, width = 10)
...
ggsave('Plots/Virome/P1_barplots_species_Virome.png',height = 6, width = 13)
```
...
ggsave('Plots/Virome/P1_barplots_phylum_indiv_Virome.png',height = 8, width = 10)
...
ggsave('Plots/Virome/P1_barplots_family_indiv_Virome.png',height = 8, width = 10)
...
ggsave('Plots/Virome/P1_barplots_genus_indiv_Virome.png',height = 8, width = 10)
...
ggsave('Plots/Virome/P1_barplots_species_indiv_Virome.png',height = 8, width = 15)
```
...
writexl::write_xlsx(list('All Results' = res, 
                    ...
                    'Results Files/Virome/Maaslin2_longitudinal_viruses.xlsx')
saveRDS(list(Function=maas.sp,SL3=maas.g,SL2=maas.f,SL1=maas.p),
        'Results Files/Virome/Maaslin2_longitudinal_viruses.rds')
```
...
ggsave('Results Files/Virome/Maaslin2_Volcano_viruses.jpeg',height = 6, width = 7.5)
```
