---
title: "9. Heatmap of Fungi vs ARGs"
...
ggsave('Plots/Functional/Fig. S3d - ARG vs Fungal Heatmap.jpeg',height=12,width=16)
```

```{r Save stats}
write.csv(df.stats,'Results Files/Functional/Fig. S3d ARG vs Fungi Heatmap Statistics.csv',row.names = F)
```
